      ...
      <main className="max-w-7xl mx-auto px-4">
        <div className="max-w-3xl mx-auto my-32 text-center">
          ...
          <p className="text-xl leading-relaxed">
            SPORT 24 er en danskejet, landsdækkende sportskæde. De er hele
            familiens sportskæde, og her finder du alt hvad hjertet kan begære
            af nyeste modetøj og sko samt funktionelt sportstøj og -sko til ham,
            hende og ungerne. Med butikker fordelt over hele Danmark og en
            velassorteret webshop kan du shoppe hvor, og hvornår det passer dig
            bedst.
          </p>
        </div>
        <Image
        ...
        <div className="max-w-7xl mx-auto my-32">
          ...
          <div className="flex flex-col sm:flex-row sm:flex-wrap sm:justify-evenly gap-6 md:gap-10">
            ...
            <CaseIcon headline="459.40%" subheadline="Reach Rate" />
